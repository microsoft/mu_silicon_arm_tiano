...
/**
  ...
  @retval FALSE FEAT_VHE is not implemented.  # MU_CHANGE: Fix typo
**/
BOOLEAN
EFIAPI
ArmHasVhe (
...
/**
  ...
  @retval FALSE FEAT_TRBE is not implemented.  # MU_CHANGE: Fix typo
**/
BOOLEAN
EFIAPI
ArmHasTrbe (
...
/**
  ...
  @retval FALSE FEAT_ETE is not implemented.  # MU_CHANGE: Fix typo
**/
BOOLEAN
EFIAPI
ArmHasEte (
