...
[LibraryClasses.common]
  ...
  PlatformBootManagerLib|ArmVirtPkg/Library/PlatformBootManagerLib/PlatformBootManagerLib.inf   # MU_CHANGE
...
!if $(TTY_TERMINAL) == TRUE
  ...
  # MU_CHANGE - gArmVirtTokenSpaceGuid instead of gUefiOvmfPkgTokenSpaceGuid
